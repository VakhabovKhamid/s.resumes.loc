...
/**
 * DictionaryEducationLevelsFixture
 *
 */
class DictionaryEducationLevelsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_dictionary_education_levels_created_by' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'fk_dictionary_education_levels_modified_by' => ['type' => 'index', 'columns' => ['modified_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_dictionary_education_levels_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_dictionary_education_levels_modified_by' => ['type' => 'foreign', 'columns' => ['modified_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-11 13:26:14',
                'created_by' => 1,
                'modified' => '2018-07-11 13:26:14',
                'modified_by' => 1
            ],
        ];
        parent::init();
