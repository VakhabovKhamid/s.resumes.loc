...
/**
 * ApplicantDesirableCountriesFixture
 *
 */
class ApplicantDesirableCountriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_applicant_desirable_countries_applicant_id' => ['type' => 'index', 'columns' => ['applicant_id'], 'length' => []],
            'fk_applicant_desirable_countries_dictionary_country_id' => ['type' => 'index', 'columns' => ['dictionary_country_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_applicant_desirable_countries_applicant_id' => ['type' => 'foreign', 'columns' => ['applicant_id'], 'references' => ['applicants', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_applicant_desirable_countries_dictionary_country_id' => ['type' => 'foreign', 'columns' => ['dictionary_country_id'], 'references' => ['dictionary_countries', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-13 10:28:48',
                'created_by' => 1,
                'modified' => '2018-07-13 10:28:48',
                'modified_by' => 1
            ],
        ];
        parent::init();
