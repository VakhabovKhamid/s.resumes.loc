...
/**
 * DictionaryIndustriesFixture
 *
 */
class DictionaryIndustriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_dictionary_industries_created_by' => ['type' => 'index', 'columns' => ['created_by'], 'length' => []],
            'fk_dictionary_industries_modified_by' => ['type' => 'index', 'columns' => ['modified_by'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_dictionary_industries_created_by' => ['type' => 'foreign', 'columns' => ['created_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_dictionary_industries_modified_by' => ['type' => 'foreign', 'columns' => ['modified_by'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-11 13:26:01',
                'created_by' => 1,
                'modified' => '2018-07-11 13:26:01',
                'modified_by' => 1
            ],
        ];
        parent::init();
