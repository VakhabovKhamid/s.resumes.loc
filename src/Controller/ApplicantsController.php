    ...
    public function registration()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Applicants->registerApplicant($applicant, $data, $userId)) {
                $this->Flash->success(__('Ваша анкета успешно сохранена и привязана к вашему номеру телефона. Информация о вас добавлена в Единую базу соискателей работы за рубежом. Теперь с вами могут связаться агентства для предложения работы за рубежом. Анкета привязана к вашему номеру телефона.'));
