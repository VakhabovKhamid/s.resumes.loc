...
<div class="mainContainer minContainer1000">
    <div class="textCenter" style="font-size: 20px; ">
        ...
        <br>
        <?= __("Пожалуйства, заполните все данные анкеты. Ваша анкета сохранится в нашей базе.
        Информация о вас станет доступна для компанией, занимающихся отправкой за рубеж.
        После заполнения анкеты с вами может связаться компания для предложения работы за рубежом.") ?>
    </div>
    <br>
    <br>
</div>
