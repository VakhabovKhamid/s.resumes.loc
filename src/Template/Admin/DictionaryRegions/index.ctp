 ...
 * @var \App\Model\Entity\DictionaryRegion[]|\Cake\Collection\CollectionInterface $dictionaryRegions
 */
?>
<h2><?= __('Dictionary Regions') ?></h2>
<hr>
<div class="clearfix">
    <div class="pull-left">
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        <?php foreach ($dictionaryRegions as $dictionaryRegion): ?>
        <tr>
            ...
            <td class="actions">
                <?= $this->Html->link('<span class="fa fa-eye"></span>', ['action' => 'view', $dictionaryRegion->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Html->link('<span class="fa fa-pencil"></span>', ['action' => 'edit', $dictionaryRegion->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Form->postLink('<span class="fa fa-remove"></span>', ['action' => 'delete', $dictionaryRegion->id], ['confirm' => __('Are you sure you want to delete # {0}?', $dictionaryRegion->id), 'escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
