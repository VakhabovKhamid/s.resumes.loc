 ...
 * @var \App\Model\Entity\DictionaryDistrict[]|\Cake\Collection\CollectionInterface $dictionaryDistricts
 */
?>
<h2><?= __('Dictionary Districts') ?></h2>
<hr>
<div class="clearfix">
    <div class="pull-left">
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        <?php foreach ($dictionaryDistricts as $dictionaryDistrict): ?>
        <tr>
            ...
            <td class="actions">
                <?= $this->Html->link('<span class="fa fa-eye"></span>', ['action' => 'view', $dictionaryDistrict->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Html->link('<span class="fa fa-pencil"></span>', ['action' => 'edit', $dictionaryDistrict->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Form->postLink('<span class="fa fa-remove"></span>', ['action' => 'delete', $dictionaryDistrict->id], ['confirm' => __('Are you sure you want to delete # {0}?', $dictionaryDistrict->id), 'escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
