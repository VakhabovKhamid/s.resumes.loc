 ...
 * @var \App\Model\Entity\DictionaryEducationLevel[]|\Cake\Collection\CollectionInterface $dictionaryEducationLevels
 */
?>
<h2><?= __('Dictionary Education Levels') ?></h2>
<hr>
<div class="clearfix">
    <div class="pull-left">
...
<table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-condensed">
    ...
    <tbody>
        <?php foreach ($dictionaryEducationLevels as $dictionaryEducationLevel): ?>
        <tr>
            ...
            <td class="actions">
                <?= $this->Html->link('<span class="fa fa-eye"></span>', ['action' => 'view', $dictionaryEducationLevel->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Html->link('<span class="fa fa-pencil"></span>', ['action' => 'edit', $dictionaryEducationLevel->id], ['escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
                <?= $this->Form->postLink('<span class="fa fa-remove"></span>', ['action' => 'delete', $dictionaryEducationLevel->id], ['confirm' => __('Are you sure you want to delete # {0}?', $dictionaryEducationLevel->id), 'escape' => false, 'class' => 'btn btn-default btn-sm']) ?>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
