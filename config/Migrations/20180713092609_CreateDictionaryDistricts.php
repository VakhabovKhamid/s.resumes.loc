...
class CreateDictionaryDistricts extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table = $this->table('dictionary_districts',['id' => false, 'primary_key' => 'id']);
        ...
        $table->addColumn('region_id','biginteger',[
            'signed'=>'',
            'null'=>false,
            'limit'=>20,
            'comment'=>'Идентификатор справочника "Области"'
        ]);
        ...
        $table->addIndex(['region_id'])->addForeignKey('region_id','dictionary_regions','id');
        $table->create();
    }
}
